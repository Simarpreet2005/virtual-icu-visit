        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center gap-4 ml-auto">
                ...
                <a href="{{ route('notifications.index') }}" class="p-2 rounded-xl text-slate-500 hover:bg-slate-50 transition-all relative">
                    ...
                    <span data-notification-count class="absolute top-1.5 right-1.5 w-4 h-4 bg-rose-500 rounded-full border-2 border-white text-[9px] font-bold text-white flex items-center justify-center {{ $unreadCount > 0 ? '' : 'hidden' }}">
